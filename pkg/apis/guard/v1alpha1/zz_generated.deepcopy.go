...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertReport) DeepCopyInto(out *AlertReport) {
	clone := in.DeepCopy()
	*out = *clone
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceReports) DeepCopyInto(out *ServiceReports) {
	*out = *in
	if in.Alerts != nil {
		in, out := &in.Alerts, &out.Alerts
		*out = make([]AlertReport, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceReports.
func (in *ServiceReports) DeepCopy() *ServiceReports {
	if in == nil {
		return nil
	}
	out := new(ServiceReports)
	in.DeepCopyInto(out)
	return out
}
